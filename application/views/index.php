...
<!--
        <style>
            ...
            .slider-container li:nth-child(2) {
                background-image: url(./assets/images/newbanner-2.jpg);
                background-position: center;
                background-repeat: no-repeat;
                background-size: cover;
                height: 700px;
...
-->
          ...
          <section class="banner"> 
			...
			<div class="swiper-slide banner-1">
                <div>
                    <img src="./assets/images/slide-1.jpg" class="d-none d-md-block" alt="">
                    <img src="./assets/images/slide1-mob.jpg" class="d-md-none" alt="">
                </div>
			...
			<div class="swiper-slide banner-2">
                 <div>
                  <img src="./assets/images/slide-2.jpg" class="d-none d-md-block" alt="">
                     <img src="./assets/images/slide2-mob.jpg" class="d-md-none" alt="">
                </div>
				<div class="carousel-caption ">               
                <div class="banner-padd">
                        <h1 style="color:#666;">₹ 399<br> Per week </h1>
                        <div class="banner-btn"><button class="create-plan-button">More FAQ,s</button> </div>
			...
			<div class="swiper-slide banner-3">
                 <div>
                   <img src="./assets/images/slide-3-1.jpg" class="d-none d-md-block" alt="">
                     <img src="./assets/images/slide3-mob.jpg" class="d-md-none" alt="">
                </div>
				<div class="carousel-caption ">             
                     <div class="banner-padd">
                         <h3> Sign Up Now</h3>
                         <h2>Get One Week</h2>
                        <h1>Free </h1>
                        <div class="banner-btn"><button class="create-plan-button">Click Here</button> </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 col-12 text-center text-md-left">
                    ...
                    <div class="about-icon">
                        <img src="./assets/images/quality.png?" alt="100% Quality">
                        <p>100%<br> Quality</p>
                    </div>
                    <div class="about-icon">
                        <img src="./assets/images/door-step.png?" alt="At your doorstep ">
                      ...
                      ?>
                            <div class="plan-pic">
                               <div>
                                ...
                                <div>
                                 <img src="<?= base_url('assets/images/icon-599-2.png') ?>" class="icon-599"></div>
                           </div>
                      ...
                      ?>
                           ...
                           <div class="plan-pic">
                               <div>
                                ...
                                <div>
                                   <img src="<?= base_url('assets/images/icon-799-1.png')?>" class="icon-799"></div>
                           </div>
                      ...
                      ?>
                           <div class="plan-pic">
                               <div>
                                ...
                                <div>
                                   <img src="<?= base_url('assets/images/icon-999-1.png') ?>" class="icon-999"></div>
                           </div>
...
-->
                            ...
                            <div class="col-md-6">
                                <!-- Image -->
                                    <img src="<?= base_url('assets/images/exper-fresh.jpg')?>" alt="Responsive Image" class="container-side-img">
